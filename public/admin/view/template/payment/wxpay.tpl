          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="entry-wxpay-token"><span data-toggle="tooltip" title="<?php echo $help_token; ?>"><?php echo $entry_wxpay_token; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="wxpay_token" value="<?php echo $wxpay_token; ?>" placeholder="<?php echo $entry_wxpay_token; ?>" id="entry-wxpay-token" class="form-control"/>
                </div>
              </div>
