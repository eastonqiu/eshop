...
class ModelAccountWeixinLogin extends Model {
	public function existPlatformId($platformId) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "weixin_login WHERE platform_id = '" . $platformId . "'");
		return $query->row['total'];
	}

	public function existCustomerId($customerId) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "weixin_login WHERE customer_id = '" . (int)$customer_id . "'");
		return $query->row['total'];
	}
	...
	public function addCustomer($data,$platformId) {
		...
		$customer_id = $this->db->getLastId();
      	...
      	$this->db->query("INSERT INTO " . DB_PREFIX . "weixin_login SET customer_id = '" . (int)$customer_id . "', platform_id = '" . $platformId . "'");
	...
	public function getInfo($platformId) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "weixin_login WHERE platform_id = '" . $platformId . "'");
