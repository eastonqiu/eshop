...
class ControllerSettingSetting extends Controller {
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['config_address']) < 2) || (utf8_strlen($this->request->post['config_address']) > 256)) {
		...
		if ((utf8_strlen($this->request->post['config_telephone']) < 2) || (utf8_strlen($this->request->post['config_telephone']) > 32)) {
		...
		if ((utf8_strlen($this->request->post['config_encryption']) < 22) || (utf8_strlen($this->request->post['config_encryption']) > 1024)) {
